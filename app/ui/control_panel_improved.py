...
class ControlPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        layout.setSpacing(10)  # Ensure proper spacing between columns
        ...
        # Use stretch factor instead of fixed percentage for better adaptability
        layout.addLayout(left_column, 1)  # 1 part of space
        ...
        # Middle column (preprocessing and peak detection)
        middle_column = QVBoxLayout()
        
        # Add pre-processing group to middle column
        ...
        # Add peak detection group to middle column
        middle_column.addWidget(peak_group)
        
        # Use stretch factor instead of fixed percentage for better adaptability
        layout.addLayout(middle_column, 2)  # 2 parts of space
        
        # Right column (prediction, validation, and actions)
        ...
        # Add model interpretation group to right column
        ...
        # Add tabs to right column with proper sizing
        ...
        # Add actions group to right column
        right_column.addWidget(actions_group)
        
        # Use stretch factor instead of fixed percentage for better adaptability
        layout.addLayout(right_column, 2)  # 2 parts of space
